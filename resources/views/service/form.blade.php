                ...
                <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('service_name_ar') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                {!! Form::text('service_name_ar', null, [
                                    'class' => 'form-control',
                                    'id' => 'serviceNameAr',
                        ...
                        <div class="form-group row {{ $errors->has('image') ? 'has-error' : '' }}">
                            ...
                            @if (!empty($service->image))
                                <img src="{{ asset('api/service-image/' . $service->image) }}" width="50"
                                    height="30">
                            @endif
                        </div>
                        <div class="form-group row {{ $errors->has('icon') ? 'has-error' : '' }}">
                            <label for="exampleInputIcon" class="col-sm-3 col-form-label">Icon</label>
                            <div class="input-group col-sm-6">
                                <div class="custom-file">
                                    <input type="file" name="icon" class="custom-file-input" id="exampleInputIcon">
                                    <label class="custom-file-label" for="exampleInputIcon">Choose file</label>
                                </div>
                                {!! $errors->first('icon', '<p class="help-block">:message</p>') !!}
                            </div>
                            @if (!empty($service->icon))
                                <img src="{{ asset('api/service-icon/' . $service->icon) }}" width="50" height="30">
                            @endif
                        </div>
                    </div>
                    <!-- /.card-body -->
