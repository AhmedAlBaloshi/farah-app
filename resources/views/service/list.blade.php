                            ...
                            <tr>
                                ...
                                <td> 
                                    @if(!empty($service->image))
                                        <img src="/service-image/{{$service->image}}" height="70" width="70">
                                    @else
                                        N/A
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('service_edit',$service->service_id) }}" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-success btn-xs">
                                        <span class="fa fa-edit"></span>
                                    </a>
                                    <button data-href="{{ route('service_delete',$service->service_id) }}" data-original-title="Delete" class="delete btn btn-danger btn-xs delete-record">
