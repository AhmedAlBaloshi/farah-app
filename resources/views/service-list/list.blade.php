                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($service->image))
                                                <img src="{{ asset('api/service-list-image/' . $service->image) }}"
                                                    height="70" width="70">
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td>
                                            <a href="{{ route('service_list_edit', $service->service_list_id) }}"
                                                data-toggle="tooltip" data-original-title="Edit"
                                                class="edit btn btn-success btn-xs">
                                                <span class="fa fa-edit"></span>
                                            </a>
                                            <button
                                                onClick="deleteRecord('{{ route('service_list_delete', $service->service_list_id) }}')"
